...
total_pair_energy = calculate_total_pair_energy(coordinates, box_length, \
 simulation_cutoff2)
tail_correction = calculate_tail_correction(box_length, simulation_cutoff, \
 num_particles)
...
for i_step in range(n_steps):
    ...
    current_energy = get_particle_energy(coordinates, box_length, i_particle, \
     simulation_cutoff2)
    ...
    proposed_coordinates -= box_length * np.round(proposed_coordinates / \
     box_length)
